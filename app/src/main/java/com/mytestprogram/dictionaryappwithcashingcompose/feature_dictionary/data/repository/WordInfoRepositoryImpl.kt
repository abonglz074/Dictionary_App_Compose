package com.mytestprogram.dictionaryappwithcashingcompose.feature_dictionary.data.repository

import com.mytestprogram.dictionaryappwithcashingcompose.core.util.Resource
import com.mytestprogram.dictionaryappwithcashingcompose.feature_dictionary.data.local.WordInfoDao
...
class WordInfoRepositoryImpl(
    ...
    override fun getWordInfo(word: String): Flow<Resource<List<WordInfo>>> = flow {
        ...
        try {
            ...
            dao.deteleWordInfos(remoteWordInfos.map { it.word })
